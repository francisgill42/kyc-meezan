...
<v-flex xs12>
  <blockquote class="blockquote">3. In case of any change in any information provided through this form, I hereby undertake to immediately inform MEEZAN INVESTMENT of the same and provide an updated information to MEEZAN INVESTMENT within thirty (30) days.</blockquote>
</v-flex>
...
<v-flex xs12>
  <blockquote class="blockquote">5. I/We hereby permit MEEZAN INVESTMENT, subject to applicable local laws, to share my information with domestic or overseas regulators or tax authorities where necessary to establish my tax liability in any jurisdiction. Where required by domestic or overseas regulators or tax authorities, I/We further agree that MEEZAN INVESTMENT may withhold from account(s) such amount as may be required according to applicable laws, regulation and directives. I/We will indemnify and hold harmless MEEZAN INVESTMENT from any loss, action, cost, expense (including, but not limited to sums paid in settlement of claims, reasonable attorney's and consultant fees, and expert fees), claim damages, or liability which arises or is incurred by MEEZAN INVESTMENT in discharging its obligation under FATCA/CRS as a result of disclosures to external tax authorities.</blockquote>
</v-flex>

<v-flex xs12>
  <blockquote class="blockquote">6. I undertake to notify MEEZAN INVESTMENT within 30 Calender days if there is a change in any information which I have provided to MEEZAN INVESTMENT. I/We understand and accept that MEEZAN INVESTMENT reserves the right to close or suspend my account, without prior notice, if required document/information is not submitted within a stipulated time.</blockquote>
</v-flex>
